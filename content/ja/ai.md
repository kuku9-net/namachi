...
モデルを大規模にするほどAIの性能がいくらでも上がっていくようになりました<span class="footnote">
2024年現在、本当にデータセットをただ集めればよいかどうかは不明です。
モデルの生成は様々な試行錯誤の結果であり、その中にはデータセットの精査も含まれています。
このあたりのノウハウは企業の内部に蓄積されており、実情は知ることができません。
しかし大きなトレンドとして、データセットの量の問題が相対的に小さくなっていることは確かです。
</span>。
