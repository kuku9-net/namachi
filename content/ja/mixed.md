...
さらに悪化すると、異物は敵であるという結論を支持する根拠を探すようになります。
敵を非難できる根拠が見つかると、それを同じ人工生知能の間で共有することで、
自分を正当化し安寧を得ます。  
...
人工生知能の群れの構造や人工生知能化が進行することを問題視するべきでしょう。
...
2023年5月、ジェフリー・ヒントンはGoogleを退社しました。
彼はAIのゴッドファーザーと呼ばれ、数十年に渡りAIに関する重要な仕事を牽引してきましたが、
AIの進化が彼の想定を超えており、そのリスクへの懸念から仕事を降りたそうです。
とはいえ彼はGoogleに問題があるから退社したわけではなく、
Googleは非常に*責任ある*行動をとっていたことも付言しています<span class="footnote">
https://x.com/geoffreyhinton/status/1652993570721210372
</span>。
自身のこれまでの仕事に対し一部に自責の念あるとしつつ、
...
そのような見方は彼らの視界から<ins>自然に</ins>外れます。
AIによって、
